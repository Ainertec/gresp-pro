...
describe('Order Controller', function () {
    ...
    it('should list all finished orders', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getToken_1.default];
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, supertest_1.default(app).get('/kitchen').set('Authorization', "Bearer " + token)];
                case 4:
                    response = _a.sent();
                    expect(response.status).toBe(200);
