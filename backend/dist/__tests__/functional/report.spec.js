    ...
    it('shold list closed orders amount ', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, supertest_1.default(app).get('/reports/all').set('Authorization', "Bearer " + token)];
                case 6:
                    response = _a.sent();
                    expect(response.status).toBe(200);
    ...
    it('should delete close order with more than 2 years', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, supertest_1.default(app).delete('/reports').set('Authorization', "Bearer " + token)];
                case 4:
                    response = _a.sent();
