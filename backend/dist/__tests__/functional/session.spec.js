    ...
    it('it should authenticate a user', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, supertest_1.default(app).post('/sessions').send({
                            name: 'Cleiton',
                            password: '123456',
                        })];
                case 2:
    ...
    it('it should not be able to access private routes without a jwt token', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, supertest_1.default(app).get('/users')];
                case 2:
                    response = _a.sent();
                    expect(response.status).toBe(401);
                    return [2 /*return*/];
    ...
    it('it should not be able to access private routes with invalid jwt token', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, supertest_1.default(app).get('/users').set('Authorization', "askfhi34ax}")];
                case 2:
                    response = _a.sent();
                    expect(response.status).toBe(401);
                    return [2 /*return*/];
