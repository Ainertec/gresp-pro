...
describe('Item Tests', function () {
    ...
    it('should delete a product from a category, when deleted a product', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token, item, item2, item3, category, categoryUpdated;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    ...
                    expect(categoryUpdated === null || categoryUpdated === void 0 ? void 0 : categoryUpdated.products.length).toBe(2);
                    return [2 /*return*/];
            }
        });
    }); });
