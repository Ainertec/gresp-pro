...
describe('Stock controller', function () {
    ...
    it('shuld substract an item stock when the order is closeing', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token, item, order, response, itemStock;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('shuld not substract an item stock when the order is not closed, update', function () { return __awaiter(void 0, void 0, void 0, function () {
