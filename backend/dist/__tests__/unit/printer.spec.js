...
describe('Printer', function () {
    ...
    it('should create a new recipe ', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token, oldOrder, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should create a recipe updated ', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token, item, item1, item2, oldOrder, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getToken_1.default];
                case 1:
    ...
    it('should create a recipe with quantity updated', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token, item, item1, item2, oldOrder, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getToken_1.default];
