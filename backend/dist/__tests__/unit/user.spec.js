...
describe('Generate a hash password', function () {
    beforeAll(function () {
    ...
    it('should encrypt user password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, compareHash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, bcrypt_1.default.compare('123321', user.password_hash)];
                case 2:
                    compareHash = _a.sent();
