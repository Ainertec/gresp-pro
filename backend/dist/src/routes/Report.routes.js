...
var ReportRoutes = /** @class */ (function () {
    ...
    ReportRoutes.prototype.getRoutes = function (validations) {
        ...
        this.routes.delete('/reportsone', celebrate_1.celebrate({ query: validations.reportDelete }), ReportController_1.default.deleteOne);
        ...
        this.routes.get('/reports/coststock', celebrate_1.celebrate({ query: validations.report }), ReportController_1.default.costStock);
    };
    return ReportRoutes;
}());
