...
function ativarAtalhosPrincipais() {
    ...
    Mousetrap.bind('ctrl+4', function () { if (ATIVACAODEATALHOGERAL) { animacaoJanela2(); setTimeout(function () { menuEstoque(); }, 100) } else { liberarSubMenu(); } })
    ...
    Mousetrap.bind('ctrl+6', function () { if (ATIVACAODEATALHOGERAL) { animacaoJanela2(); setTimeout(function () { menuIngrediente(); liberarMouseTrap(); }, 100) } else { liberarSubMenu(); } })
    Mousetrap.bind('ctrl+7', function () { if (ATIVACAODEATALHOGERAL) { animacaoJanela2(); setTimeout(function () { menuCategoria(); }, 100) } else { liberarSubMenu(); } })
    Mousetrap.bind('ctrl+8', function () { if (ATIVACAODEATALHOGERAL) { animacaoJanela2(); setTimeout(function () { autenticacaoFuncionarioFacede(); liberarMouseTrap(); }, 100) } else { liberarSubMenu(); } })
    Mousetrap.bind('ctrl+9', function () { if (ATIVACAODEATALHOGERAL) { animacaoJanela2(); setTimeout(function () { menuImpressao(); liberarMouseTrap(); }, 100) } else { liberarSubMenu(); } })
